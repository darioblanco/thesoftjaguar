...
This blogpost is a continuation from [Useful Sublime Packages](http://thesoftjaguar.com/posts/2012/09/07/useful-sublime-packages/). The old one recommends outdated packages and I am not using Sublime Text 2 anymore, I switched to Sublime Text 3.
